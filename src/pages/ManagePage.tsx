 ...
 * 앱을 돌보는 일들.
 *
 * 설정에서 갈라 나왔다. 한 화면에 있을 때는 '보이는 모습을 고르는 일'과
 * '데이터를 다루는 일'이 섞여 있었다. 스킨을 바꾸러 들어간 사람이 전체
 * 삭제 단추를 지나쳐야 했고, 백업을 받으러 들어간 사람은 포인트 색을
 * 지나쳐야 했다. 성격이 다른 둘은 문도 달라야 한다.
 *
 * 여기 있는 것은 전부 '지금 가진 것을 어떻게 할까'다 — 내보내고,
 * 정리하고, 얼마나 쓰는지 보고, 새 버전을 받고, 마지막에는 지운다.
 */
