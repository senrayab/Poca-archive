  ...
  return (
    <nav className="pstnav" aria-label="길찾기">
      <div className="pstnav__bar">
        <NavLink className={cls('pstnav__item', here.archive)} to="/" end aria-label="보관함">
          <GridIcon size={20} />
        </NavLink>
        <NavLink className={cls('pstnav__item', here.favorites)} to="/favorites" aria-label="좋아요">
          <HeartIcon size={20} />
        </NavLink>
        <NavLink className={cls('pstnav__item', here.search)} to="/search" aria-label="검색">
          <SearchIcon size={20} />
        </NavLink>
        <NavLink className={cls('pstnav__item', here.more)} to="/more" aria-label="더보기">
          <MenuIcon size={20} />
        </NavLink>
      </div>

      <NavLink className={cls('pstnav__add', here.upload)} to="/upload" aria-label="등록하기">
        <PlusIcon size={22} />
      </NavLink>
    </nav>
  )
